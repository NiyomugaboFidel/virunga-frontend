...
const FormField: React.FC<InputField> = ({
  ...
  return (
    <div
      className={`${className} min-w-[260px] px-[16px] gap-[10px] py-[9px] rounded-[8px] border border-Gary-300 dark:border-Gary-700  flex items-center justify-center transition-all ease-in-out duration-500 `}
    > 
         <Icon
